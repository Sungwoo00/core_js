...
// for문 : 모든 데이터 순환용 => 작성 코드가 많음 => 무한루프 가능성 있음
// for ...in문: 객체 순환용 => 정해진 아이템의 갯수만큼 순환 => 배열 순환 x
...
// for (const value of languages) {
//   if (value.name.includes('Java')) continue;
//   console.table(value);
// }
...
// 객체에게 for ...of 사용하기 위한 방법
// 1. symbol.iterator => 귀찮음
// 2. 객체를 배열로 만들기
...
// Object.prototype.nickName = 'sugwoo';
