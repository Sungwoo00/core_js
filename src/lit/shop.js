...
//             <img class="productImage" src="https://picsum.photos/100/100" alt="${item.product}" />
//             <section class="productInfo">
//               <h3 class="title">${item.product}</h3>
//               <strong class="price">${item.price.toLocaleString()}원</strong>
//               <span class="quantity">${item.quantity}</span>
//             </section>
//             <button class="deleteBtn" @click=${() => this.removeItem(item.id)}>삭제</button>
//           </article>
//         `
//       )}
//     `;
...
// app.append(document.createElement('item-list'));
